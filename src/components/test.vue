<template>
    <div class="city-wrapper">
        ...
        <!--<div class="pro" ref="pro">-->
            <!--<ul>-->
                <!--<li v-for="pro in arr" ref="pros">{{pro.name}}</li>-->
            <!--</ul>-->
        <!--</div>-->
        <!--<div class="city" ref="citys">-->
            <!--<ul>-->
                <!--<li v-for="pro in cityArr">{{pro.name}}</li>-->
            <!--</ul>-->
        <!--</div>-->
        <!--<div class="dis" ref="dis">-->
            <!--<ul>-->
                <!--<li v-for="pro in districtArr">{{pro.name}}</li>-->
            <!--</ul>-->
        <!--</div>-->
        <!--<div id="iframe-wrap">-->
            <iframe id="iframe" src="http://www.17sucai.com/preview/869565/2017-11-08/CityPicker/index.html" frameborder="0"  width="100%"></iframe>
        <!--</div>-->
    </div>
</template>
...
<!--import BScroll from "better-scroll"-->
  <!--export default {-->
      ...
      <!--},-->
      <!--mounted(){-->
          <!--this.Pro = new BScroll(this.$refs.pro,{-->
              <!--probeType:3,-->
          <!--})-->
          <!--this.Pro.on("scroll",(pos)=>{-->

              <!--this.scrollY = Math.abs(pos.y)-->
              <!--console.log(this.scrollY)-->

          <!--})-->
          <!--new BScroll(this.$refs.citys)-->
          <!--new BScroll(this.$refs.dis)-->
      <!--},-->
      ...
      <!--computed:{-->
          <!--currentIndex(){-->
              ...
              <!--for (var i=0;i<this.heightArr.length;i++){-->
                  <!--var height1 = this.heightArr[i];-->
                  <!--var height2 = this.heightArr[i+1];-->
      ...
      <!--},-->
        ...
        <!--methods: {-->
            ...
            <!--calculateHeight(){-->
                ...
                <!--let foodTypeList = this.$refs.pros;-->
                <!--var h=0;-->
                <!--for (var i=0;i<foodTypeList.length;i++){-->
                    <!--h += foodTypeList[i].offsetHeight;-->
